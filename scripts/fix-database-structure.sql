...
-- Ejecutar para permitir HTML largo en los templates

-- 1. Verificar la estructura actual
DESCRIBE document_templates;

-- 2. Cambiar el campo content a LONGTEXT para permitir HTML largo
ALTER TABLE document_templates MODIFY COLUMN content LONGTEXT;

-- 3. Verificar que se aplicó el cambio
DESCRIBE document_templates;

-- 4. Ahora insertar el template completo del boleto
