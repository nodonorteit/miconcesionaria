-- Script para actualizar el template con la sintaxis correcta de variables
-- Cambiar de sintaxis antigua a nueva: {{companyName}} -> {{company.name}}

-- 1. Verificar el template actual
SELECT 
    id,
    name,
    type,
...
-- 2. Actualizar el template con la sintaxis correcta
